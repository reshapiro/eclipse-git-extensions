...
public class MergeCommand
   ...
   private static final Parameter STRATEGY_OPTION = new RadioButtonParameter("Merge",
                                                                             "Strategy",
                                                                             STRATEGY_OPTIONS,
                                                                             STRATEGY_OPTIONS[0]);
   private static final Parameter THEIRS_OURS_OPTION = new RadioButtonParameter("Merge", "Recursive", THEIRS_OURS, THEIRS_OURS[0]);
   private static final ParameterSet PARAMS = new ParameterSet("Merge",
                                                               STRATEGY_OPTION,
                                                               FF_OPTION,
                                                               THEIRS_OURS_OPTION,
                                                               RECURSIVE_PATIENCE,
                                                               RECURSIVE_IGNORE_SPACES,
                                                               REF);
   ...
   void getArgs()
      ...
      if (strategyOption.equals("recursive") || strategyOption.equals(STRATEGY_OPTIONS[0])) {
         ...
         /*
          * TODO: other recursive white-space options: ignore-space-change,
          * ignore-space-at-eol
          */
      }
      append(ffOption);
